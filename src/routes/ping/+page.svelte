<script lang="ts">
  ...
  const pingTargets: PingTarget[] = [
    ...
    { name: '讯飞星辰', slug: 'xfyun-spark', region: '国内', service: 'Astron Coding Plan', url: 'https://maas-api.cn-hf.xfyun.cn/v1/chat/completions' },
    { name: '京东云', slug: 'jd-cloud', region: '国内', service: 'JoyBuilder Coding Plan', url: 'https://api.jdcloud.com/v1/chat/completions' },
    { name: '小米', slug: 'xiaomi', region: '国内', service: 'MiMo Token Plan', url: 'https://api.xiaomimimo.com/v1/chat/completions' },
    { name: '联通云', slug: 'unicom-cloud', region: '国内', service: '元景 Token Plan', url: 'https://api.cucloud.cn/v1/chat/completions' },
    ...
    { name: 'Z.ai', slug: 'z-ai', region: '国外', service: 'GLM Plan (国际版)', url: 'https://api.z.ai/v1/chat/completions' },
    { name: 'OpenCode', slug: 'opencode', region: '国外', service: 'OpenCode Go', url: 'https://api.opencode.ai/v1/chat/completions' },
  ];
