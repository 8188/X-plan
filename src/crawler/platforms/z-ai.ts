 ...
 */
export class ZaiCrawler extends BaseLightCrawler {
  slug = 'z-ai';
  name = 'Z.ai';
  ...
  parse(html: string): Partial<CrawledPlatform> {
    ...
    const maxPrice = foundPrices[2] || 469;

    return {
      platform: {
        name: 'Z.ai',
        slug: 'z-ai',
        service: 'Z.ai Coding Plan',
        category: 'other',
      ...
      tiers: [
        ...
        { name: 'Max', limit_short: '20x Lite额度/月', price: maxPrice, description: null, sort_order: 2 },
      ],
      models: [
      ...
      tools: [
        { name: 'Cursor', sort_order: 0 },
        { name: 'OpenCode', sort_order: 1 },
